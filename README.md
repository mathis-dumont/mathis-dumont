...
Currently a Data Scientist intern at Mirakl, where I work on fine-tuning and aligning open-weight models (with DPO) to handle catalog onboarding at large scale every week. Before that, I built a multi-agent LLM pipeline to reverse-engineer 200k+ lines of legacy Fortran at ArcelorMittal.
